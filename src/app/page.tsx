...
const Step3Download: React.FC<Step3DownloadProps> = ({ qrValue }) => {
...
export default function HomePage() {
  ...
  return (
    <div className="container mx-auto px-4">
      <h1 className="text-3xl font-semibold text-white text-center mt-12 mb-2">
        Generate your free QR Code in 2 easy steps.
      </h1>
      <p className="text-lg italic text-gray-300 text-center mb-12 font-light">
